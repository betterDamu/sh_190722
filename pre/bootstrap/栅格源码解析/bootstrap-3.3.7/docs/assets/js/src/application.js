...
!function ($) {
  ...
  $(function () {
    ...
    $('.tooltip-01_基本使用').tooltip({
      selector: '[data-toggle="tooltip"]',
      container: 'body'
    })
    $('.popover-01_基本使用').popover({
    ...
    $('.highlight').each(function () {
      var btnHtml = '<div mine="zero-clipboard"><span mine="btn-clipboard">Copy</span></div>'
      $(this).before(btnHtml)
    })
