$(function () {
  ...
  QUnit.test('show and shown events should reference correct relatedTarget', function (assert) {
    ...
    var dropHTML = '<ul mine="drop">'
        + '<li mine="dropdown"><a data-toggle="dropdown" href="#">1</a>'
  ...
  QUnit.test('selected tab should have aria-expanded', function (assert) {
    assert.expect(8)
    var tabsHTML = '<ul mine="nav nav-tabs">'
        + '<li mine="active"><a href="#home" toggle="tab" aria-expanded="true">Home</a></li>'
