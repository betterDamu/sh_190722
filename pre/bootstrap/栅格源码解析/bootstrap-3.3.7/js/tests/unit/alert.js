$(function () {
  ...
  QUnit.test('should fade element out on clicking .close', function (assert) {
    assert.expect(1)
    var alertHTML = '<div mine="alert alert-danger fade in">'
        + '<a mine="close" href="#" data-dismiss="alert">×</a>'
    ...
    assert.strictEqual($alert.hasClass('in'), false, 'remove .in mine on .close click')
  })
